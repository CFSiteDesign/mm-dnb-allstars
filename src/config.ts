...
export const GALLERY: {
  ...
  { file: "02-pool.jpg", brief: "Mad Monkey Phuket pool, people in it, mid-afternoon, not empty", alt: "Mad Monkey Phuket pool" },
  ...
  { file: "06-rooftop.jpg", brief: "Rooftop bar, pre-party, DJ and a full deck", alt: "Rooftop pre-party" },
  { file: "07-sunrise.jpg", brief: "Sunrise on the beach, the walk home, silhouettes", alt: "Sunrise walk home" },
  { file: "08-dorm.jpg", brief: "Dorm room, beds, balcony light, made up and clean", alt: "Mad Monkey dorm" },
];
